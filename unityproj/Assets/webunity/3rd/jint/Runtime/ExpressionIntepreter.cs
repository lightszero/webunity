...
namespace Jint.Runtime
{
    public class ExpressionInterpreter
    {
        ...
        public JsValue EvaluateCallExpression(CallExpression callExpression)
        {
            ...
            {
                var aa1 = callExpression.Arguments.Select<Expression,object>(EvaluateExpression);
                var aa2 = aa1.Select<object,JsValue>(_engine.GetValue);
                arguments = aa2.ToArray();
        ...
        {
            var a1 = newExpression.Arguments.Select<Expression,object>(EvaluateExpression);
            var a2 = a1.Select<object,JsValue>(_engine.GetValue);
            JsValue[] arguments = a2.ToArray();
